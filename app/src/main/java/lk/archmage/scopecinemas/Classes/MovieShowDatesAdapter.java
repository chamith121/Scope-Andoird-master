...
public class MovieShowDatesAdapter extends RecyclerView.Adapter<MovieShowDatesAdapter.MyViewHolder> {
    ...
    public MovieShowDatesAdapter(Context context, ArrayList getDates, NowShowingMovieData nowShowingMovieData) {
        this.context = context;
        this.movieDatesArray = getDates;
        this.nowShowingMovieData = nowShowingMovieData;
    }
