...
public class MovieShowDatesByTheaterAdapter extends RecyclerView.Adapter<MovieShowDatesByTheaterAdapter.MyViewHolder> {
    ...
    public MovieShowDatesByTheaterAdapter(Context context, ArrayList getDates, TheaterByMovieData theaterByMovieData) {
        this.context = context;
        this.movieDatesArray = getDates;
        this.theaterByMovieData = theaterByMovieData;
    }
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        public MyViewHolder(@NonNull View itemView) {
            super(itemView);
            monthNameTv = itemView.findViewById(R.id.dayNameTv);
    ...
    public void onBindViewHolder(@NonNull MyViewHolder myViewHolder, int i) {
        ...
        try {
            ...
            myViewHolder.dayNameTv.setText(splitDate[1].toUpperCase());
            ...
            myViewHolder.layoutBtn.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    intent.putExtra("theaterByMovieOBJ", theaterByMovieData);
