...
public class ComingSoonMovieData implements Parcelable {
    ...
    public ComingSoonMovieData(String movieId, String movieName, String startDate, String endDate, String youTubeUrl,
                               String youTubeId, String runTime, String movieLanguage, String movieType, String movieSynopsis,
                               String movieImage, String movieLImage, String movieMobileImage, String trailer,
                               ArrayList<String> castObject, String imdb, String checkAdults, ArrayList<String> vistaCode,
                               ArrayList<String> genre, String fact, String featured, ArrayList<String> directors,
                               ArrayList<String> producers, ArrayList<String> musicians, ArrayList<String> writters) {
    ...
    protected ComingSoonMovieData(Parcel in) {
    ...
    public static final Creator<ComingSoonMovieData> CREATOR = new Creator<ComingSoonMovieData>() {
        @Override
        public ComingSoonMovieData createFromParcel(Parcel in) {
            return new ComingSoonMovieData(in);
        }

        @Override
        public ComingSoonMovieData[] newArray(int size) {
            return new ComingSoonMovieData[size];
        }
    };
